...
class Exercise_4_1__3Test:
 ...
 protected:
  ...
  static const size_t LESS_THAN_EQUILIBRIUM_TEST_SIZE = 100;
  std::vector<int> less_than_equilibrium_set_;

  static const size_t EQUILIBRIUM_TEST_SIZE = 950;
  std::vector<int> equilibrium_set_;

  static const size_t BIGGER_THAN_EQUILIBRIUM_TEST_SIZE = 5000;
...
TEST_F(Exercise_4_1__3Test, BruteForceEquilibriunTest) {
  ...
  const auto& test_set = equilibrium_set_;
...
TEST_F(Exercise_4_1__3Test, BruteForceBiggerThanEquilibriunTest) {
  ...
  const auto& test_set = bigger_than_equilibrium_set_;
